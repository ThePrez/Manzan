...
public class EmailDestination extends ManzanGenericCamelRoute {
    ...
    public EmailDestination(final CamelContext _context, final InstanceContext _ctx, final String _name, final String _type,
        ...
        super(_context, _ctx, _name, _type, (_port == -1) ? _smtpServer : _smtpServer + ":" + _port, _format, _uriParams, _headerParams, _componentOptions);
    }
