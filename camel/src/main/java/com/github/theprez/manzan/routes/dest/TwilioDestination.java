...
public class TwilioDestination extends ManzanGenericCamelRoute {
    public TwilioDestination(CamelContext context, final String _name, final String _format, final Map<String, String> _uriParams) {
        ...
        twilio.setUsername(m_uriParams.remove("sid").toString());
        twilio.setPassword(m_uriParams.remove("token").toString());
    }
